...
--
-- Host: 172.18.63.11    Database: seata_account
-- ------------------------------------------------------
...
CREATE TABLE `t_account` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='account table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_account` VALUES (1,'xiaoming',7998,1693194072,1693297609);
...
-- Dump completed on 2023-08-29 16:51:59