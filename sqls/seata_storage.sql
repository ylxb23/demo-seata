...
--
-- Host: 172.18.63.11    Database: seata_storage
-- ------------------------------------------------------
...
CREATE TABLE `t_product` (
  ...
  `price` int NOT NULL COMMENT '鍗曚环',
  `stock` int NOT NULL DEFAULT '0' COMMENT '搴撳瓨鏁伴噺',
  `create_time` int NOT NULL,
  `update_time` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='product table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_product` VALUES (1,'An Apple',2,799,1693211354,1693292781);
...
-- Dump completed on 2023-08-29 16:52:19